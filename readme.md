...
![skills](https://skillicons.dev/icons?i=html,css,js,php,bootstrap,wordpress,nodejs,mysql,py,cpp,discordjs,unity,github,gitlab,git,vscode,figma,ps,pr,ae,gmail,linux,windows&theme=light)
