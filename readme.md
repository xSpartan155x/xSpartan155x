...
![skills](https://skillicons.dev/icons?i=html,css,tailwind,sass,js,ts,php,bootstrap,wordpress,angular,react,nextjs,vite,nginx,nodejs,npm,electron,mysql,py,c,cpp,java,docker,lua,discord,bots,discordjs,unity,github,gitlab,git,stackoverflow,vscode,figma,ps,pr,ae,svg,gmail,linux,ubuntu,kali,windows&theme=light)
