...
![skills](https://skillicons.dev/icons?i=html,css,js,php,bootstrap,wordpress,nodejs,mysql,py,c,cpp,java,discordjs,unity,github,gitlab,git,vscode,figma,ps,pr,ae,gmail,linux,ubuntu,windows&theme=light)
